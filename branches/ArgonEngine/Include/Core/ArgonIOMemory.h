#ifndef _ARGONIOMEMORY_HEADER_
#define _ARGONIOMEMORY_HEADER_
...
namespace Argon
{
	class IOMemory : public IArgonUnknownImp<IOStream, GUID_IOStream>
	{
	public:
		IOMemory(ulong Length);
		IOMemory(const char* Data, ulong Length);
